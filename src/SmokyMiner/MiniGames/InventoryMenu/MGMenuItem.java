...
public class MGMenuItem 
{
	...
	public MGMenuItem(JavaPlugin plugin, Material icon, int iconData, String name, Sound clickSound, MGItemListener listener)
	{
		this.plugin = plugin;
	...
	public MGMenuItem(JavaPlugin plugin, Material icon, int iconData, String name, List<String> lore, MGItemListener listener)
	{
		this.plugin = plugin;
