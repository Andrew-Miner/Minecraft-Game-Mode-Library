...
public class MGCommandParser 
{
	...
	protected static void buildCommandIdentifiers(HashMap<Integer, HashMap<String, command_info[]>> rowInsertionIdentifier) 
	{
		...
		command_info.EFFECT.addIdentifier(CMD_ID);
		command_info.EFFECT.addIdentifier(DESC_ID);
		
		// Row 0
		
		HashMap<String, command_info[]> insertionIdentifier = new HashMap<String, command_info[]>();
		
		command_info[] commandIds = {command_info.ARENA, command_info.INFO, command_info.EFFECT};
	...
	protected static void buildStateArray(int[][] stateArray, int maxRows, int maxCols)
	{
	    // Current State Array Configuration:
	     /*==============================================================================================================================================================================================
	      *  | Random Str | Arena | Info | Enable | Disable | List | World | Max | Players | Teams | Add | Center | Spawn | Spectator | Team | Description | Bound | Default | Ingame | Remove | Effect |
	      * -|------------|-------|------|--------|---------|------|-------|-----|---------|-------|-----|--------|-------|-----------|------|-------------|-------|---------|--------|--------|--------|
SuccessRow* 0|            |   2   |   1  |        |         |      |       |     |         |       |     |        |       |           |      |             |       |         |        |        |   11   | Check For Starting Commands (e.g. Arena, Info)
	      * -|------------|-------|------|--------|---------|------|-------|-----|---------|-------|-----|--------|-------|-----------|------|-------------|-------|---------|--------|--------|--------|
...
SuccessRow*12|            |       |      |        |         |      |       |     |         |       |     |        |       |     1     |      |             |       |    1    |    1   |        |        |
		...
		stateArray[0][command_info.EFFECT.value()] = 11;
	}
