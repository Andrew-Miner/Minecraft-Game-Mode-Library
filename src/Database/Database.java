...
public abstract class Database 
{
	...
	public Database(JavaPlugin plugin, String host, int port, String database, String username, char[] password)
	{
	...
	public Database(JavaPlugin plugin, String host, int port, String database, String username, char[] password, DatabaseCallback callback) 
	{
		if(password != null && password.length > PASSWORD_LENGTH)
			throw new IllegalArgumentException("Password exceeds " + PASSWORD_LENGTH + " character limit");
	...
	public void executeQueryAsync(String query, DatabaseCallback callBack)
	{
		plugin.getServer().getScheduler().runTaskAsynchronously(plugin, new Runnable()
		{
			@Override
