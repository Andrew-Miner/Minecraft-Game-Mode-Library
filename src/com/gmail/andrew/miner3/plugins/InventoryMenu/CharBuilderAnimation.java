...
public class CharBuilderAnimation extends ItemAnimation
{
	public CharBuilderAnimation(InventoryMenu menu)
	{
		super(menu);
	}
	...
	public String updateName(String name)
	{
		...
		String[] nameSplit = ItemAnimation.STRIP_COLOR_PATTERN.split(this.name);
		String[] tempSplit = ItemAnimation.STRIP_COLOR_PATTERN.split(name);

		ArrayList<String> colorSplit = new ArrayList<String>();
		Matcher m = ItemAnimation.STRIP_COLOR_PATTERN.matcher(this.name);
